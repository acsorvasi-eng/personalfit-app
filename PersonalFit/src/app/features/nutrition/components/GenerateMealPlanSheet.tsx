...
// ─── Premium Loader ──────────────────────────────────────────
import SharedPremiumLoader, { MEAL_GEN_PHASES, getPhaseText } from '../../../components/PremiumLoader';
...
function PremiumLoader({ phase, t }: { phase: 'plan' | 'chef'; t: (key: string) => string }) {
  ...
  return (
    <SharedPremiumLoader
      progress={progress}
      phaseText={getPhaseText(progress, MEAL_GEN_PHASES, t)}
      subtext={t('generatePlan.loaderSubtext')}
      fullScreen={false}
    />
  );
}
