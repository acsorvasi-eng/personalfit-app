...
const ro: LocalePartial = {
  ...
  // Fasting Journey
  'fasting.journey.title': 'Configurare post',
  'fasting.journey.cancel': 'Anulare',
  'fasting.journey.next': 'Următorul',
  'fasting.journey.saving': 'Se salvează...',
  'fasting.journey.regenerate': 'Regenerare plan alimentar',
  'fasting.journey.step1Title': 'Ce fel de post ții?',
  'fasting.journey.step2Title': 'Ce restricții ai?',
  'fasting.journey.step3Title': 'Cât durează postul?',
  'fasting.journey.step4Title': 'Rețete de post',
  'fasting.journey.orthodoxDesc': 'Post de miercuri-vineri + perioade de post. Fără produse animale.',
  'fasting.journey.catholicDesc': 'Postul Mare, Miercurea Cenușii, Vinerea Mare. Fără carne.',
  'fasting.journey.customDesc': 'Tu definești regulile și perioada.',
  'fasting.journey.step2Hint': 'Preselectat pe baza tipului de post ales, dar poți modifica.',
  'fasting.journey.restrict.meat': 'Carne',
  'fasting.journey.restrict.dairy': 'Lactate',
  'fasting.journey.restrict.eggs': 'Ouă',
  'fasting.journey.restrict.fish': 'Pește',
  'fasting.journey.restrict.alcohol': 'Alcool',
  'fasting.journey.restrict.sweets': 'Dulciuri',
  'fasting.journey.step3HintReligious': 'Selectează perioadele active de post:',
  'fasting.journey.weeklyRecurring': 'Zile recurente săptămânal',
  'fasting.journey.customRange': 'Perioadă personalizată',
  'fasting.journey.from': 'De la',
  'fasting.journey.to': 'Până la',
  'fasting.journey.step4Question': 'Dorești rețete de post?',
  'fasting.journey.yesRecipes': 'Da, include rețete de post',
  'fasting.journey.recipe1Name': 'Supă de linte cu roșii',
  'fasting.journey.recipe2Name': 'Vinete la grătar cu sos tahini',
  'fasting.journey.recipe3Name': 'Ardei umpluți cu orez (vegan)',
  'fasting.journey.protein': 'proteine',
