...
const en: LocalePartial = {
  ...
  // Fasting Journey
  'fasting.journey.title': 'Set up fasting',
  'fasting.journey.cancel': 'Cancel',
  'fasting.journey.next': 'Next',
  'fasting.journey.saving': 'Saving...',
  'fasting.journey.regenerate': 'Regenerate meal plan',
  'fasting.journey.step1Title': 'What kind of fast?',
  'fasting.journey.step2Title': 'What do you restrict?',
  'fasting.journey.step3Title': 'How long is your fast?',
  'fasting.journey.step4Title': 'Fasting recipes',
  'fasting.journey.orthodoxDesc': 'Wednesday-Friday fasting + Lenten periods. No animal products.',
  'fasting.journey.catholicDesc': 'Lent, Ash Wednesday, Good Friday. No meat.',
  'fasting.journey.customDesc': 'You define the rules and the period.',
  'fasting.journey.step2Hint': 'Pre-selected based on your fasting type, but you can modify.',
  'fasting.journey.restrict.meat': 'Meat',
  'fasting.journey.restrict.dairy': 'Dairy',
  'fasting.journey.restrict.eggs': 'Eggs',
  'fasting.journey.restrict.fish': 'Fish',
  'fasting.journey.restrict.alcohol': 'Alcohol',
  'fasting.journey.restrict.sweets': 'Sweets',
  'fasting.journey.step3HintReligious': 'Select the active fasting periods:',
  'fasting.journey.weeklyRecurring': 'Weekly recurring days',
  'fasting.journey.customRange': 'Custom period',
  'fasting.journey.from': 'From',
  'fasting.journey.to': 'To',
  'fasting.journey.step4Question': 'Would you like fasting recipes?',
  'fasting.journey.yesRecipes': 'Yes, include fasting recipes',
  'fasting.journey.recipe1Name': 'Tomato lentil soup',
  'fasting.journey.recipe2Name': 'Grilled eggplant with tahini sauce',
  'fasting.journey.recipe3Name': 'Stuffed peppers with rice (vegan)',
  'fasting.journey.protein': 'protein',
